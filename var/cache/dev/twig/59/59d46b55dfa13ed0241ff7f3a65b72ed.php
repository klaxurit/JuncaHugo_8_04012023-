...
class __TwigTemplate_9ce342573d62c7d1e3db1da7f768f813 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 192, $this->source); })()), "data", [], "any", false, false, false, 192), "forms", [], "any", false, false, false, 192))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 196
                echo "                ";
                echo twig_call_macro($macros["__internal_parse_1"], "macro_form_tree_entry", [$context["formName"], $context["formData"], true], 196, $context, $this->getSourceContext());
                echo "
            ";
            }
    ...
    public function macro_form_tree_entry($__name__ = null, $__data__ = null, $__is_root__ = null, ...$__varargs__)
    {
        ...
        <div class=\"tree-inner\" data-tab-target-id=\"";
            ...
            echo ">
                ";
            // line 447
            echo twig_escape_filter($this->env, ((array_key_exists("name", $context)) ? (_twig_default_filter((isset($context["name"]) || array_key_exists("name", $context) ? $context["name"] : (function () { throw new RuntimeError('Variable "name" does not exist.', 447, $this->source); })()), "(no name)")) : ("(no name)")), "html", null, true);
            echo "
            </span>
        </div>
...
";
    ...
    public function macro_form_tree_details($__name__ = null, $__data__ = null, $__forms_by_hash__ = null, $__show__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if ( !((array_key_exists("show", $context)) ? (_twig_default_filter((isset($context["show"]) || array_key_exists("show", $context) ? $context["show"] : (function () { throw new RuntimeError('Variable "show" does not exist.', 463, $this->source); })()), false)) : (false))) {
                echo " hidden";
            }
            echo "\" ";
        ...
        ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["data"] ?? null), "type_class", [], "any", true, true, false, 465)) {
                ...
                echo $this->env->getFunction('profiler_dump')->getCallable()($this->env, twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 466, $this->source); })()), "type_class", [], "any", false, false, false, 466));
                echo "</h3>
        ";
            }
            // line 468
...
($context["forms_by_hash"] ?? null), twig_get_attribute($this->env, $this->source, $context["error"], "origin", [], "any", false, false, false, 492), [], "array", true, true, false, 492)) {
                    ...
                    if (twig_get_attribute($this->env, $this->source, $context["error"], "trace", [], "any", false, false, false, 499)) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["stacked"]) {
                            // line 502
                            echo "                                ";
                            echo $this->env->getFunction('profiler_dump')->getCallable()($this->env, $context["stacked"]);
                            echo "
                            ";
                        }
                        $_parent = $context['_parent'];
        ...
        <div id=\"";
            ...
            ";
                ...
                ";
                    ...
                    <td>";
                        // line 632
                        echo $this->env->getFunction('profiler_dump')->getCallable()($this->env, $context["value"]);
                        echo "</td>
                    <td>
                        ";
                        // line 635
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/home/axurit/Projets/SYMFONY/JuncaHugo_8_04012023/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/form.html.twig");
    }
}
