...
class __TwigTemplate_82b1e3362e4bee9442264c2d0c783b02 extends \Twig\Template
{
    private $source;
    private $macros = [];
                ...
                if ((twig_length_filter($this->env, $context["calls"]) == 0)) {
                    ...
                    foreach ($context['_seq'] as $context["key"] => $context["value"]) {
                        ...
                        if (($context["key"] == "time")) {
                            // line 111
                            echo "                                                ";
                            echo twig_escape_filter($this->env, twig_sprintf("%0.2f", (1000 * twig_get_attribute($this->env, $this->source, $context["value"], "value", [], "any", false, false, false, 111))), "html", null, true);
...
$context["key"] == "hit_read_ratio")) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                        ...
                        echo "()</td>
                                        <td>";
                        // line 142
                        echo $this->env->getFunction('profiler_dump')->getCallable()($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["call"], "value", [], "any", false, false, false, 142), "result", [], "any", false, false, false, 142), 2);
                        echo "</td>
                                    </tr>
                                ";
                        ++$context['loop']['index0'];
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/home/axurit/Projets/SYMFONY/JuncaHugo_8_04012023/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/cache.html.twig");
    }
}
