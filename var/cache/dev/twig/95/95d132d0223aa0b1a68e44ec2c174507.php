...
class __TwigTemplate_05cf00f3a279e524441fed7edb69ed14 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_set_handler($__controller__ = null, $__route__ = null, $__method__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["controller"] ?? null), "class", [], "any", true, true, false, 287)) {
                // line 288
                if (((array_key_exists("method", $context)) ? (_twig_default_filter((isset($context["method"]) || array_key_exists("method", $context) ? $context["method"] : (function () { throw new RuntimeError('Variable "method" does not exist.', 288, $this->source); })()), false)) : (false))) {
                ...
                // line 292
                if (((array_key_exists("route", $context)) ? (_twig_default_filter((isset($context["route"]) || array_key_exists("route", $context) ? $context["route"] : (function () { throw new RuntimeError('Variable "route" does not exist.', 292, $this->source); })()), false)) : (false))) {
                    // line 293
                    echo "@";
...
{% macro set_handler(controller, route, method) %}
    ...
    {%- endif %}
{% endmacro %}
", "@WebProfiler/Collector/request.html.twig", "/home/axurit/Projets/SYMFONY/JuncaHugo_8_04012023/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/request.html.twig");
    }
}
