...
$b = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), (\dirname(__DIR__, 4).'/app/Resources'), [0 => (\dirname(__DIR__, 4).'/app')], false);
